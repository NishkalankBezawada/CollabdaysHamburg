---
name: setup-configure-vitest
description: This comprehensive prompt guide provides all the necessary changes to configure Vitest testing framework for your SharePoint Framework (SPFx) project.
---
