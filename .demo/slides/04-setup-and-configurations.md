...
- Vitest should be installed and configured before it can be used to run your test.
- Installation can be via npm.

- Vitest config file is used to configure specific things about our Vitest tests
...
-  What can you customize using your Vitest configuration?
    - Whether to include or exclude files
